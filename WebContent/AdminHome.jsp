...
<html>
<head>
<title>SatExam Admin |Home</title>
...
<!--inner block start here-->
    ...
    <h1 align="center" style="color:orange; " > Welcome Admin!!</h1> <br><br><br>
<div  >
	  <!--mainpage chit-chating-->
<div  >
	<div  >
               <div  class="work-progres" align="center" >
                            <div class="chit-chat-heading" >
                                  SAT Exam Report <br> <br>
                            </div>
		      ...
		      <ul id="menu" >
		        ...
		        <li id="menu-academico" ><a href="#"><i class="fa fa-cog"></i><span>TEACHER</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         <ul id="menu-academico-sub" >
		          	 ...
		          	 <li id="menu-academico-boletim" ><a href="AStatus.jsp">Active Teachers</a></li>
		          	  <li id="menu-academico-boletim" ><a href="Teacherlogind.jsp">Deactive Teachers</a></li>	
		          </ul>
		        ...
		        <li id="menu-academico" ><a href="Home.jsp"><i class="glyphicon glyphicon-off"></i><span>LOG OUT</span></a>
