...
<html>
<head>
<title>SatExam Department|Home</title>
...
<input type="text" name="dept" placeholder="Enter The Department Name" required="required" style="width: 30%; margin: 0em 0 -1em 0em;"> <input type="submit"  value="ADD DEPARTMENT" style="width: 30%; margin: -2em 0 0em 22em;">
</form>
</div>
...
<div class="table-responsive">
                              ...
                              <%
                                ...
                                <tr>
                                  ...
                                  <td><a href="Editdept.jsp?id=<%=rs.getInt(1)%>&name=<%=rs.getString(2) %>"><span class="label label-success">Edit</span></a>
                                  <a href="DeleteDept.jsp?id=<%=rs.getInt(1)%>"><span class="label label-danger">Delete</span></a>
                                  </td>
		    ...
		    <div class="menu">
		      <ul id="menu" >
		         ...
		         <ul id="menu-academico-sub" >
		             ...
		             <li id="menu-academico" ><a href="ADepMenu.jsp"><i class="fa fa-th-list"></i><span>DEPARTMENT</span></a>
