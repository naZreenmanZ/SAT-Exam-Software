...
<html>
<head>
<title>SatExam Update Department|Home</title>
...
<input type="text" name="dept" value="<%=request.getParameter("name")%>" placeholder="Enter The Department Name" required="required" style="width: 30%; margin: 0em 0 -1em 0em;"> <input type="submit"  value="UPDATE DEPARTMENT" style="width: 30%; margin: -2em 0 0em 22em;">
</form>
</div></div>
	<div class="clearfix"> </div>
