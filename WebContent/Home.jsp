            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
						 ...
						 <div class="header-right" style="width: 40%;">
							 <div class="profile_details_left"><!--notifications of menu start -->
								  <ul class="nofitications-dropdown">
									<li class="dropdown head-dpdn" style="">
										<a href="AdminLogin.jsp"> &nbsp;&nbsp;&nbsp; <i class="fa fa-sign-in"></i></a>&nbsp;&nbsp;&nbsp;
										</li>
										<li class="dropdown head-dpdn">Admin Login</li>
...
<div class="inner-block" style="padding : 0px 0px 0px;">
<div  style="background-image: url('images/5.jpg');padding-bottom: 20em;"></div>
