...
<html>
<head>
<title>SatExam AddCONTROLLER|Home</title>
      ...
      <div class="table-responsive"> 
                              ...
                              <%
                              		...
                              		{ 
                              		  ...
                              		  ResultSet rs = st.executeQuery("select * FROM tbl_teacher  where control='no'");
                                      while(rs.next()){
                                    	  id=rs.getInt(1);
                                    	  count++;
                                ...
                                <tr>
                                  <td><%=count %></td>
                                   ...
                                   <td> <%=tech%></td>                    
                                <td>
                           <%--   <a href="add_ctrler?id=<%=rs.getInt(1)%>"><span class="label label-success">ADD</span></a></form> 
                            --%>   
                            <form action="add_ctrler1" method="post">
   ...
   <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li id="menu-academico" ><a href="Adcontroller.jsp"><i class="glyphicon glyphicon-off"></i><span>LOG OUT</span></a>
