...
<%@page import="java.sql.ResultSet"%><!--Author: W3layouts
			...
			<div class="signup-block">
			 ...
			 <%
				...
				<div class="sign-down">
				  ...
				  <h5><a href="Home.jsp">Go Back to Home</a></h5>
				</div>
			</div>
    </div>
</div>
   ...
   <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li><a href="#"><i class="fa fa-list-alt"></i><span>REGISTER</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
		            <li><a href="AdminLogin.jsp">Teacher</a></li>
		            <li><a href="TeacherLogin.jsp">Student</a></li>
		       ...
		       <!--   <li id="menu-comunicacao" ><a href="#"><i class="fa fa-book nav_icon"></i><span>Element</span><span class="fa fa-angle-right" style="float: right"></span></a>
		        ...
		        <li id="menu-academico" ><a href="#"><i class="fa fa-road"></i><span>LOGIN</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul id="menu-academico-sub" >
		          	 <li id="menu-academico-boletim" ><a href="Teacherlogin.jsp">Teacher Login</a></li>
		            <li id="menu-academico-avaliacoes" ><a href="StudentLogin.jsp">Student Login</a></li>	
		            <li id="menu-academico-avaliacoes"><a href="AdminLogin.jsp">Admin Login</a></li>	           
		          </ul>
		        </li>
		        
		        <li><a href="About.jsp"><i class="fa fa-th-large"></i><span>ABOUT</span></a></li>
		           <li><a href="charts.html"><i class="fa fa-film"></i><span>GALLARY</span></a></li>
